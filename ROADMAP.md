...
- [x] **MCP Hello World**: Connect ONE simple tool to verify MCP protocol.

## 🟠 Phase 2: Tactical Skills (PAC + Core Four)

- [ ] **Spec Prompts**: Create the "Ultimate Spec Prompt Template".
- [ ] **Context R&D**: Implement the R&D Context Framework.
- [ ] **PITER Loop**: Build a "New Project" PITER pipeline.
